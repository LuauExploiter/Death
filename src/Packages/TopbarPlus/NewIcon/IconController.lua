-- Script Path: game:GetService("ReplicatedStorage").NewIcon.IconController
...
if v13 and v13.IconController ~= script then
    ...
    v36.left = {
        ...
        getOffset = function() --[[ Line: 68 ]] --[[ Name: getOffset ]]
            ...
            local l_leftOffset_0 = v14.leftOffset;
            ...
            if not v39 or not v40 or not v25 or not v23 then

            end;
            return l_leftOffset_0;
        end, 
        getStartOffset = function() --[[ Line: 77 ]] --[[ Name: getStartOffset ]]
    ...
    v36.mid = {
        startScale = 0.5, 
        getOffset = function() --[[ Line: 86 ]] --[[ Name: getOffset ]]
            return 0;
        end, 
        getStartOffset = function(v42) --[[ Line: 89 ]] --[[ Name: getStartOffset ]]
            -- upvalues: v14 (copy)
            local l_midGap_0 = v14.midGap;
            return -v42 / 2 + l_midGap_0 / 2;
        end, 
        records = {}
    };
    v36.right = {
        startScale = 1, 
        getOffset = function() --[[ Line: 97 ]] --[[ Name: getOffset ]]
            ...
            local v46 = l_Character_0 and l_Character_0:FindFirstChild("Humanoid");
            local v47 = if v46 then v46.RigType == Enum.HumanoidRigType.R6 else false;
            local v49, v50 = xpcall(function() --[[ Line: 41 ]]
                -- upvalues: l_StarterGui_0 (ref)
                return l_StarterGui_0:GetCore("TopbarEnabled");
            end, function(_) --[[ Line: 43 ]]
                return true;
            end);
            if (v49 and v50 or l_VRService_0.VREnabled) and (l_StarterGui_0:GetCoreGuiEnabled(Enum.CoreGuiType.PlayerList) or l_StarterGui_0:GetCoreGuiEnabled(Enum.CoreGuiType.Backpack) or not v47 and l_StarterGui_0:GetCoreGuiEnabled(Enum.CoreGuiType.EmotesMenu)) then
                l_rightOffset_0 = l_rightOffset_0 + 48;
            end;
            return l_rightOffset_0;
        end, 
        getStartOffset = function(v51) --[[ Line: 107 ]] --[[ Name: getStartOffset ]]
            -- upvalues: v36 (copy)
            return -v51 - v36.right.getOffset();
        end, 
        records = {}
    };
    ...
    v14.leftGap = 12 - (l_TouchEnabled_0 and 6 or 0);
    v14.midGap = 12;
    v14.rightGap = 12;
    v14.leftOffset = 0;
    v14.rightOffset = 0;
    ...
    local v56 = 0;
    v14.iconAdded:Connect(function(v57) --[[ Line: 147 ]]
        -- upvalues: v17 (copy), v14 (copy), v56 (ref)
        v17[v57] = true;
        if v14.gameTheme then
            v57:setTheme(v14.gameTheme);
        end;
        v57.updated:Connect(function() --[[ Line: 152 ]]
            -- upvalues: v14 (ref)
            v14.updateTopbar();
        end);
        v57.selected:Connect(function() --[[ Line: 156 ]]
    ...
    v14.iconRemoved:Connect(function(v61) --[[ Line: 175 ]]
    ...
    v14.setGameTheme = function(v62) --[[ Line: 187 ]] --[[ Name: setGameTheme ]]
        -- upvalues: v14 (copy)
        v14.gameTheme = v62;
    ...
    v14.setDisplayOrder = function(v66) --[[ Line: 195 ]] --[[ Name: setDisplayOrder ]]
        -- upvalues: v16 (copy)
        v16.DisplayOrder = tonumber(v66) or v16.DisplayOrder;
    end;
    v14.setDisplayOrder(10);
    v14.getIcons = function() --[[ Line: 201 ]] --[[ Name: getIcons ]]
        -- upvalues: v17 (copy)
        local v67 = {};
    ...
    v14.getIcon = function(v70) --[[ Line: 209 ]] --[[ Name: getIcon ]]
        -- upvalues: v17 (copy)
    ...
    v14.disableHealthbar = function(v73) --[[ Line: 218 ]] --[[ Name: disableHealthbar ]]
        -- upvalues: v14 (copy)
        local v74 = true;
        if v73 ~= nil then
            v74 = v73;
    ...
    v14.disableControllerOption = function(v75) --[[ Line: 224 ]] --[[ Name: disableControllerOption ]]
    ...
    v14.canShowIconOnTopbar = function(v77) --[[ Line: 232 ]] --[[ Name: canShowIconOnTopbar ]]
    ...
    v14.getMenuOffset = function(v78) --[[ Line: 239 ]] --[[ Name: getMenuOffset ]]
        -- upvalues: v14 (copy)
    ...
    v54 = false;
    v14.updateTopbar = function() --[[ Line: 262 ]] --[[ Name: updateTopbar ]]
        -- upvalues: v14 (copy), v20 (ref), v54 (ref), l_RunService_0 (copy), v36 (copy), v17 (copy), v16 (copy), l_TweenService_0 (copy)
        local function v92(v85, v86) --[[ Line: 263 ]] --[[ Name: getIncrement ]]
            -- upvalues: v14 (ref)
        ...
        if v20 then
            ...
            task.defer(function() --[[ Line: 283 ]]
                ...
                for v98, v99 in pairs(v36) do
                    ...
                    if #l_records_0 > 1 then
                        if v99.reverseSort then
                            table.sort(l_records_0, function(v101, v102) --[[ Line: 303 ]]
                                return v101:get("order") > v102:get("order");
                            end);
                        else
                            table.sort(l_records_0, function(v103, v104) --[[ Line: 305 ]]
                ...
                local function v133(v125, v126, v127) --[[ Line: 341 ]] --[[ Name: getBoundaryX ]]
                    -- upvalues: v14 (ref)
                ...
                local function v142(v134, v135) --[[ Line: 350 ]] --[[ Name: getSizeX ]]
                    -- upvalues: v14 (ref)
                ...
                for v143, v144 in pairs(v36) do
                    ...
                    if l_overflowIcon_0 then
                        ...
                        do
                            ...
                            local function _(v158) --[[ Line: 376 ]] --[[ Name: doesExceed ]]
                            ...
                            l_l_v152_0_0 = function(v161) --[[ Line: 387 ]] --[[ Name: checkBoundaryExceeded ]]
    ...
    v14.setTopbarEnabled = function(v200, v201) --[[ Line: 528 ]] --[[ Name: setTopbarEnabled ]]
        ...
        if v14.controllerModeEnabled then
            if v200 then
                ...
                elseif v206 then
                    ...
                    v22 = l_Indicator_0.InputBegan:Connect(function(v212) --[[ Line: 611 ]]
                        -- upvalues: v14 (ref)
                ...
                if not v16.TopbarContainer.Visible then
                    ...
                    v16.TopbarContainer:TweenPosition(UDim2.new(0, 0, 0, -v16.TopbarContainer.Size.Y.Offset + 32), Enum.EasingDirection.Out, Enum.EasingStyle.Quad, 0.1, true, function() --[[ Line: 628 ]]
                        -- upvalues: v16 (ref)
    ...
    v14.setGap = function(v214, v215) --[[ Line: 651 ]] --[[ Name: setGap ]]
        -- upvalues: v14 (copy)
    ...
    v14.setLeftOffset = function(v218) --[[ Line: 665 ]] --[[ Name: setLeftOffset ]]
        -- upvalues: v14 (copy)
        v14.leftOffset = tonumber(v218) or 0;
        v14.updateTopbar();
    end;
    v14.setRightOffset = function(v219) --[[ Line: 670 ]] --[[ Name: setRightOffset ]]
        -- upvalues: v14 (copy)
    ...
    local v220 = {};
    v55.CharacterAdded:Connect(function() --[[ Line: 677 ]]
        -- upvalues: v220 (ref)
    ...
    v14.clearIconOnSpawn = function(v223) --[[ Line: 683 ]] --[[ Name: clearIconOnSpawn ]]
        -- upvalues: v55 (copy), v220 (ref)
        coroutine.wrap(function() --[[ Line: 684 ]]
    ...
    v14._updateSelectionGroup = function(_, v226) --[[ Line: 693 ]] --[[ Name: _updateSelectionGroup ]]
    ...
    local function _() --[[ Line: 721 ]] --[[ Name: getScaleMultiplier ]]
    ...
    v14._setControllerSelectedObject = function(v232) --[[ Line: 729 ]] --[[ Name: _setControllerSelectedObject ]]
        -- upvalues: v14 (copy), l_GuiService_0 (copy)
        ...
        task.delay(0.1, function() --[[ Line: 733 ]]
    ...
    v14._enableControllerMode = function(v234) --[[ Line: 741 ]] --[[ Name: _enableControllerMode ]]
        ...
        if v14.controllerModeEnabled == v234 then
            ...
            if v234 then
                ...
                v22 = l_Indicator_1.InputBegan:Connect(function(v241) --[[ Line: 758 ]]
                    -- upvalues: v14 (ref)
    ...
    v14._enableControllerModeForIcon = function(v248, v249) --[[ Line: 774 ]] --[[ Name: _enableControllerModeForIcon ]]
        -- upvalues: l_GuiService_0 (copy)
    ...
    local v262 = false;
    v14.setupHealthbar = function() --[[ Line: 811 ]] --[[ Name: setupHealthbar ]]
        -- upvalues: v262 (ref), l_RunService_0 (copy), l_Parent_0 (copy), l_StarterGui_0 (copy), v14 (copy), v55 (copy)
        if v262 then
            return;
        else
            v262 = true;
            task.defer(function() --[[ Line: 819 ]]
                -- upvalues: l_RunService_0 (ref), l_Parent_0 (ref), l_StarterGui_0 (ref), v14 (ref), v55 (ref)
                l_RunService_0.Heartbeat:Wait();
                require(l_Parent_0).new():setProperty("internalIcon", true):setName("_FakeHealthbar"):setRight():setOrder(-420):setSize(80, 32):lock():set("iconBackgroundTransparency", 1):give(function(v263) --[[ Line: 831 ]]
                    ...
                    local function v273(v271, v272) --[[ Line: 874 ]] --[[ Name: powColor3 ]]
                        return Color3.new(math.pow(v271.R, v272), math.pow(v271.G, v272), (math.pow(v271.B, v272)));
                    end;
                    local function _(v274, v275, v276, v277) --[[ Line: 882 ]] --[[ Name: lerpColor ]]
                        -- upvalues: v273 (copy)
                        v277 = v277 or 2;
                        local l_v277_0 = v277;
                    ...
                    local v282 = true;
                    local function v300(v283) --[[ Line: 890 ]] --[[ Name: listenToHealth ]]
                        ...
                        if not v283 then
                            ...
                            if not v284 then
                                ...
                                local function v299() --[[ Line: 899 ]] --[[ Name: updateHealthBar ]]
                                    -- upvalues: l_StarterGui_0 (ref), v284 (copy), v14 (ref), v282 (ref), v263 (ref), v268 (ref), v269 (ref), v270 (ref), v267 (ref)
                                    local l_l_StarterGui_0_CoreGuiEnabled_0 = l_StarterGui_0:GetCoreGuiEnabled(Enum.CoreGuiType.Health);
                                    local v286 = v284.Health / v284.MaxHealth;
                                    if v286 == 1 or v14.healthbarDisabled or v282 and l_l_StarterGui_0_CoreGuiEnabled_0 == false then
                    ...
                    v55.CharacterAdded:Connect(function(v301) --[[ Line: 936 ]]
                        -- upvalues: v300 (copy)
                        v300(v301);
                    end);
    ...
    v14._determineControllerDisplay = function() --[[ Line: 944 ]] --[[ Name: _determineControllerDisplay ]]
    ...
    coroutine.wrap(function() --[[ Line: 971 ]]
        ...
        v14._determineControllerDisplay();
        local function v309() --[[ Line: 995 ]] --[[ Name: iconClicked ]]
        ...
        l_UserInputService_0.InputBegan:Connect(function(v310, _) --[[ Line: 1005 ]]
        ...
        task.defer(function() --[[ Line: 1058 ]]
            -- upvalues: l_VoiceChatService_0 (ref), v55 (ref), v14 (ref), v25 (ref), v23 (ref)
            local v319 = nil;
            local v320 = nil;
            while true do
                local l_status_0, l_result_0 = pcall(function() --[[ Line: 1061 ]]
            ...
            local function _() --[[ Line: 1067 ]] --[[ Name: checkVoiceChatManuallyEnabled ]]
            ...
            task.delay(10, function() --[[ Line: 1079 ]]
        ...
        if not v23 then
            ...
            if game.CreatorType == Enum.CreatorType.Group then
                local l_status_1, l_result_1 = pcall(function() --[[ Line: 1097 ]]
            ...
            if v55.UserId ~= l_CreatorId_0 then
                ...
                local l_status_2, l_result_2 = pcall(function() --[[ Line: 1105 ]]
    ...
    l_GuiService_0.MenuClosed:Connect(function() --[[ Line: 1118 ]]
    ...
    l_GuiService_0.MenuOpened:Connect(function() --[[ Line: 1127 ]]
        -- upvalues: l_VRService_0 (copy), v19 (ref), v14 (copy)
        if l_VRService_0.VREnabled then
            return;
        else
